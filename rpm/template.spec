...
Name:           ros-kilted-metavision-driver
Version:        3.0.2
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS metavision_driver package

License:        Apache License 2.0
URL:            https://index.ros.org/p/metavision_driver/#kilted
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-kilted-event-camera-msgs
Requires:       ros-kilted-openeb-vendor
...
BuildRequires:  ros-kilted-openeb-vendor
...
* Tue Apr 22 2025 Bernd Pfrommer <bernd.pfrommer@gmail.com> - 2.0.1-2
- Autogenerated by Bloom
